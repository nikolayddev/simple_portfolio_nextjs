  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-y-auto">
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-16 sm:gap-20 md:gap-24 lg:gap-32 xl:gap-48">
          {/* BIOGRAPHY */}
          <div className="flex flex-col gap-12 justify-center">
            <h1 className="font-bold text-2xl">BIOGRAPHY</h1>
            <p className="text-lg">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Laudantium magni esse odio dolore modi sapiente. Consequatur est
              facere dignissimos nostrum fugit ullam, dolorum eaque laudantium
              officia hic facilis praesentium omnis?
            </p>
